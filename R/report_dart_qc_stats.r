...
report_dart_qc_stats <- function(dart_data, basedir, species, dataset, threshold_missing_loci = 0.5) {
   ...
   if(!dir.exists(paste(basedir, species, "/qual_stat/", sep=""))) {
      cat("  Analysis directory for this species does not exist and is being created at ", paste(basedir, species, sep=""), "\n" )
      dir.create(paste(basedir, species, "/qual_stat/", sep=""))
   } 
